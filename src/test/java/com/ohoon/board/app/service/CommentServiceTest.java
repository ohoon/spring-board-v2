...
class CommentServiceTest {
    ...
    @Test
    void write() {
        Page<CommentDto> before = commentService.listByPostId(postReadDto.getPostId(), PageRequest.of(0, 30));
        ...
        Page<CommentDto> after = commentService.listByPostId(postReadDto.getPostId(), PageRequest.of(0, 30));
